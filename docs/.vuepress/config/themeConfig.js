...
module.exports = {
  ...
  logo: '/img/avada.jpg', // 导航栏logo
  repo: 'https://github.com/dreamSeekerYu?tab=repositories', // 导航栏右侧生成Github链接
  ...
  author: {
    ...
    name: 'XiaoGe Bai', // 必需
    link: 'https://github.com/dreamSeekerYu', // 可选的
  },
  blogger: {
    // 博主信息，显示在首页侧边栏
    avatar: '/img/avada.jpg',
    name: 'XiaoGe Bai',
    slogan: '前端界的小学生',
  },
  social: {
